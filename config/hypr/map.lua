...
hl.bind("SUPER + S", hl.dsp.submap("snapshot"))
hl.define_submap("snapshot", "reset", function()
    hl.bind("A", hl.dsp.exec_cmd("snapshot area"))
    hl.bind("D", hl.dsp.exec_cmd("snapshot desktop"))
    hl.bind("M", hl.dsp.exec_cmd("snapshot monitor"))
    hl.bind("W", hl.dsp.exec_cmd("snapshot window"))
...
hl.define_submap("project", "reset", function()
    ...
    hl.bind("q", hl.dsp.exec_cmd('$TERM_PROGRAM -e project -A queue'))
    hl.bind("w", hl.dsp.exec_cmd('$TERM_PROGRAM -e project -A work'))
    hl.bind("t", hl.dsp.exec_cmd('$TERM_PROGRAM -e project -A work tracks'))
...
hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd('rofi -show ssh'))
